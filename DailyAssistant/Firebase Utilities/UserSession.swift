...
final class UserSession {
    ...
    public func createNewAccount(email: String, password: String) {
        Auth.auth().createUser(withEmail: email, password: password) { (authDataResult, error) in
            if let error = error {
                ...
                DatabaseManager.firebaseDB.collection(UserDefaultsKeys.DefaultSearchKey)
    ...
    public func updateUser(displayName: String?, photoURL: URL?) {
        ...
        // this is how you update an auth user profile
        ...
        request.commitChanges { (error) in
            if let error = error {
                ...
                DatabaseManager.firebaseDB
                    .collection(UserDefaultsKeys.DefaultSearchKey)
